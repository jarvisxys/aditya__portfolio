  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div
        className={
          isDark
            ? "modal-card modal-card--research dark-mode"
            : "modal-card modal-card--research"
        }
        onClick={e => e.stopPropagation()}
      >
        <button className="modal-close" onClick={onClose}>
        ...
        {paper.highlights && (
          <div className="modal-highlights">
            <h3 className="modal-section-title modal-section-title--green">
              Key Contributions
            </h3>
            <ul>
        ...
        <div className="modal-tech-row" style={{margin: "1rem 0"}}>
          {paper.tags &&
            paper.tags.map(t => (
              <span key={t} className="tech-badge tech-badge--green">
                {t}
              </span>
            ))}
        </div>
...
function FeaturedCard({project, isDark, onClick}) {
  return (
    <div
      className={isDark ? "featured-card dark-mode" : "featured-card"}
      onClick={onClick}
    >
      ...
      <div className="featured-card__inner">
        ...
        <div className="featured-card__left">
          ...
          <div className="featured-card__actions">
            <button className="sp-card-btn" onClick={onClick}>
              View Full Details →
            </button>
            {project.footerLink &&
              project.footerLink.find(l => l.name === "Live Demo") && (
                <a
                  href={
                    project.footerLink.find(l => l.name === "Live Demo").url
                  }
                  target="_blank"
                  rel="noopener noreferrer"
            ...
            {project.footerLink &&
              project.footerLink.find(l => l.name === "GitHub") && (
                <a
  ...
  return (
    <div className={isDark ? "sp-card dark-mode" : "sp-card"}>
      ...
      <div className="sp-card__body">
        {project.tagline && (
          <p className="sp-card__tagline">{project.tagline}</p>
        )}
  ...
  return (
    <div className={isDark ? "paper-card dark-mode" : "paper-card"}>
          ...
          <>
            ...
            {!paper.image && (
              <div className="paper-card__img-placeholder">
                ...
                <span className="paper-card__placeholder-label">
                  Research Paper
                </span>
              </div>
            )}
      ...
      <div className="paper-card__body">
        ...
        <div className="sp-card__actions">
          <button
            className="sp-card-btn sp-card-btn--outline-green"
            onClick={onClick}
          >
            Details →
          </button>
