...
export default function Contact() {
  ...
  function handleSubmit() {
    ...
    window.open(`mailto:${contactInfo.email_address}?subject=${sub}&body=${body}`, "_blank");
    setTimeout(() => { setStatus("sent"); setName(""); setEmail(""); setMessage(""); }, 400);
  }
      ...
      <div className="main" id="contact">
        <div className="contact-section">
          ...
          <div className="contact-left">
            ...
            <h1 className={ic("contact-heading")}>
              {contactInfo.title}
            </h1>

            {/* Subtitle — uppercase, letter-spaced, small caps style */}
            <p className={ic("contact-sub")}>
            ...
            <div className="contact-info-block">
              <div className={ic("contact-row")}>
                <IconMail />
                <a href={`mailto:${contactInfo.email_address}`} className={ic("contact-row__link")}>
              ...
              {contactInfo.number && (
                <div className={ic("contact-row")}>
                  <IconPhone />
                  <a href={`tel:${contactInfo.number}`} className={ic("contact-row__link")}>
                    {contactInfo.number}
                  </a>
                </div>
              )}
              ...
              <div className={ic("contact-row")}>
                ...
                <span>
                  ...
                  <span className={contactInfo.isHireable ? "hire-yes" : "hire-no"}>
            ...
            <div className="cfb">
              ...
              {status === "sent" && (
                <p className="cfb-ok">✓ Mail client opened — see you in the inbox!</p>
              )}
            </div>
          </div>
